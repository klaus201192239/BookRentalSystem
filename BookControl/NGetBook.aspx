<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NGetBook.aspx.cs" Inherits="NGetBook" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width:100%;height:100%">
        ...
        <br />
        请输入借书人的证件号：<asp:TextBox ID="textbox" runat="server"></asp:TextBox>
        &nbsp&nbsp
        ...
        <table>
            <tr>
                <td style="width:55px;">姓名</td><td style="width:72px;">卡号</td>
                 <td style="width:90px;">电话</td><td style="width:33px;">IDBN</td>
                 <td style="width:90px;">书名</td><td style="width:90px;">出版社</td>
                 <td style="width:70px;">租借时间</td><td style="width:35px;">操作</td>
            </tr>
        </table>
        <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="1" OnItemCommand="dLGoodsList_ItemCommand">
                 <ItemTemplate>
                    <table>
                        <tr>
                            <td style="width:55px;"><asp:Label ID="Label1" runat="server" Text='<%# Eval("RentName") %>'></asp:Label></td>
                            <td style="width:72px;"><asp:Label ID="Label2" runat="server" Text='<%# Eval("Idcard") %>'></asp:Label></td>
                            <td style="width:94px;"><asp:Label ID="Label3" runat="server" Text='<%# Eval("Phone") %>'></asp:Label></td>
