<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DeleteBookInformation.aspx.cs" Inherits="DeleteBookInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="width:100%;height:100%">
        ...
        <div style="width:100%;height:80%">
            ...
            <asp:Button ID="dele" runat="server" Text="确认删除该图书信息" OnClick="DeleBook" />
        </div>
    </div>
</asp:Content>
